...
#include "terminal/terminals/example_pcsc_contactless_SDI010.hpp"
...
ExampleTerminalPCSCContactless_SDI010::~ExampleTerminalPCSCContactless_SDI010() {
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::init() {
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::loadAndListReaders() {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::connect(const char* reader) {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::sendCommand(unsigned char command[], DWORD command_length) {
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::sendTypeA(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::sendTypeB(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::sendTypeF(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
	response.response = "Not implemented";
	return response;
}

ResponsePacket ExampleTerminalPCSCContactless_SDI010::isAlive() {
	unsigned char command[] = { 0x00, 0x00, 0x00, 0x00 };
	return sendCommand(command, sizeof(command));
}

ResponsePacket ExampleTerminalPCSCContactless_SDI010::diag() {
	ResponsePacket response;
	LONG resp;
	CHAR szReader[200];
	DWORD cch = 200;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::disconnect() {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::restart() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::retrieveAtr(BYTE* bAttr, DWORD* cByte) {
	LONG resp;
	ResponsePacket response;
	DWORD cch = 200;
	DWORD dwState;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::powerOFFField() {
	ResponsePacket response;
	unsigned char command[] = { 0xFF, 0xCC, 0x00, 0x00, 0x02, 0x96, 0x00 };
	return sendCommand(command, sizeof command);
}

ResponsePacket ExampleTerminalPCSCContactless_SDI010::powerONField() {
	LONG resp;
	ResponsePacket response;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::pollTypeA() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContactless_SDI010::pollTypeB() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContactless_SDI010::pollTypeF() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::coldReset() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::warmReset() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
std::string ExampleTerminalPCSCContactless_SDI010::errorToString(LONG error) {
	switch (error) {
...
ResponsePacket ExampleTerminalPCSCContactless_SDI010::handleErrorResponse(std::string context_message, LONG error) {
...
LONG ExampleTerminalPCSCContactless_SDI010::handleRetry() {
