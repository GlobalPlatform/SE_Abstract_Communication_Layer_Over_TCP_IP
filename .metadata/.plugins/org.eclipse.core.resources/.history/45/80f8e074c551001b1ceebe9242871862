...
#ifndef TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACTLESS_SDI010_H_
#define TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACTLESS_SDI010_H_
...
class ExampleTerminalPCSCContactless_SDI010: public ITerminalLayer {
private:
...
public:
	ExampleTerminalPCSCContactless_SDI010() = default;
	~ExampleTerminalPCSCContactless_SDI010();
...
#endif /* TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACTLESS_SDI010_H_ */
