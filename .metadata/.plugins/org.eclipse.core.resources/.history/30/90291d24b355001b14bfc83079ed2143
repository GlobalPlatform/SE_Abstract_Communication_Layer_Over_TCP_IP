...
#ifndef TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACTLESS_IDENTIV_4700_H_
#define TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACTLESS_IDENTIV_4700_H_
...
class ExampleTerminalPCSCContactless_IDENTIV_4700: public ITerminalLayer {
private:
...
public:
	ExampleTerminalPCSCContactless_IDENTIV_4700() = default;
	~ExampleTerminalPCSCContactless_IDENTIV_4700();
...
#endif /* TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACTLESS_IDENTIV_4700_H_ */
