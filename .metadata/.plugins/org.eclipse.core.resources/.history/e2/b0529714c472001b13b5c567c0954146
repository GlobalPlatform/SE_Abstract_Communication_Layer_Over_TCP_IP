...
#ifndef TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACT_H_
#define TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACT_H_
...
public:
	ExampleTerminalPCSCContact() = default;
...
#endif /* TERMINAL_TERMINALS_TERMINAL_PCSC_CONTACT_H_ */
