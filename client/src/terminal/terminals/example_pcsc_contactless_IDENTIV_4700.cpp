...
#include "terminal/terminals/example_pcsc_contactless_IDENTIV_4700.hpp"
...
ExampleTerminalPCSCContactless_IDENTIV_4700::~ExampleTerminalPCSCContactless_IDENTIV_4700() {
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::init() {
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::loadAndListReaders() {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::connect(const char* reader) {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::sendCommand(unsigned char command[], DWORD command_length) {
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::sendTypeA(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::sendTypeB(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::sendTypeF(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
	response.response = "Not implemented";
	return response;
}

ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::isAlive() {
	unsigned char command[] = { 0x00, 0x00, 0x00, 0x00 };
	return sendCommand(command, sizeof(command));
}

ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::diag() {
	ResponsePacket response;
	LONG resp;
	CHAR szReader[200];
	DWORD cch = 200;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::disconnect() {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::restart() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::retrieveAtr(BYTE* bAttr, DWORD* cByte) {
	LONG resp;
	ResponsePacket response;
	DWORD cch = 200;
	DWORD dwState;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::powerOFFField() {
	ResponsePacket response;
	unsigned char command[] = { 0xFF, 0xCC, 0x00, 0x00, 0x02, 0x96, 0x00 };
	return sendCommand(command, sizeof command);
}

ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::powerONField() {
	LONG resp;
	ResponsePacket response;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::pollTypeA() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::pollTypeB() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::pollTypeF() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::coldReset() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::warmReset() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
std::string ExampleTerminalPCSCContactless_IDENTIV_4700::errorToString(LONG error) {
	switch (error) {
...
ResponsePacket ExampleTerminalPCSCContactless_IDENTIV_4700::handleErrorResponse(std::string context_message, LONG error) {
...
LONG ExampleTerminalPCSCContactless_IDENTIV_4700::handleRetry() {
