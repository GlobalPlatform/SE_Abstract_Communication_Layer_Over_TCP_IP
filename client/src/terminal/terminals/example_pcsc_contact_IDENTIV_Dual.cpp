...
ExampleTerminalPCSCContact_IDENTIV_Dual::~ExampleTerminalPCSCContact_IDENTIV_Dual() {
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::init() {
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::loadAndListReaders() {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::connect(const char* reader) {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::sendCommand(unsigned char command[], DWORD command_length) {
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::sendTypeB(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::sendTypeF(unsigned char command[],  unsigned long int command_length) {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::isAlive() {
	unsigned char command[] = { 0x00, 0x00, 0x00, 0x00 };
	return sendCommand(command, sizeof(command));
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::diag() {
	ResponsePacket response;
	LONG resp;
	CHAR szReader[200];
	DWORD cch = 200;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::disconnect() {
	ResponsePacket response;
	LONG resp;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::coldReset() {
/*
	ResponsePacket response;
	LONG resp;
//	DWORD dwProtocol;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::warmReset() {
	ResponsePacket response;
	LONG resp;
	DWORD dwProtocol;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::retrieveAtr(BYTE* bAttr, DWORD* cByte) {
	LONG resp;
	ResponsePacket response;
	DWORD cch = 200;
	DWORD dwState;
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::powerOFFField() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::powerONField() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::pollTypeA() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::pollTypeB() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::pollTypeF() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::pollTypeAllTypes() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::getNotifications() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}

ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::clearNotifications() {
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::automaticInterfaceSwitching(){
	ResponsePacket response;
	response.response = "Not supported";
	return response;
}
...
std::string ExampleTerminalPCSCContact_IDENTIV_Dual::errorToString(LONG error) {
	switch (error) {
...
ResponsePacket ExampleTerminalPCSCContact_IDENTIV_Dual::handleErrorResponse(std::string context_message, LONG error) {
...
LONG ExampleTerminalPCSCContact_IDENTIV_Dual::handleRetry() {
