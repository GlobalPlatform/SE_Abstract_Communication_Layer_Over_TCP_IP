...
#ifndef INCLUDE_CLIENT_REQUESTS_POLL_TYPE_A_HPP_
#define INCLUDE_CLIENT_REQUESTS_POLL_TYPE_A_HPP_
...
class ClientEngine;
class PollTypeA : public IRequest {
public:
	PollTypeA() {}
	~PollTypeA() = default;
...
#endif /* INCLUDE_CLIENT_REQUESTS_POLL_TYPE_A_HPP_ */
