...
#ifndef INCLUDE_CLIENT_REQUESTS_GET_NOTIFICATIONS_HPP_
#define INCLUDE_CLIENT_REQUESTS_GET_NOTIFICATIONS_HPP_
...
class ClientEngine;
class GetNotifications : public IRequest {
public:
	GetNotifications() {}
...
#endif /* INCLUDE_CLIENT_REQUESTS_GET_NOTIFICATIONS_HPP_ */
