...
#ifndef INCLUDE_CLIENT_REQUESTS_SEND_TYPEF_HPP_
#define INCLUDE_CLIENT_REQUESTS_SEND_TYPEF_HPP_
...
class SendTypeF: public IRequest {
public:
	SendTypeF() {}
	~SendTypeF() {}
...
#endif /* INCLUDE_CLIENT_REQUESTS_SEND_TYPEF_HPP_ */
