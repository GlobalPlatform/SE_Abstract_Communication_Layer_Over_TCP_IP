...
#ifndef INCLUDE_CLIENT_REQUESTS_SEND_TYPEB_HPP_
#define INCLUDE_CLIENT_REQUESTS_SEND_TYPEB_HPP_
...
class SendTypeB: public IRequest {
public:
	SendTypeB() {}
	~SendTypeB() {}
...
#endif /* INCLUDE_CLIENT_REQUESTS_SEND_TYPEB_HPP_ */
