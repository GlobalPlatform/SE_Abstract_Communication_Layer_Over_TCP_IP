...
#ifndef INCLUDE_CLIENT_REQUESTS_POLL_TYPE_F_HPP_
#define INCLUDE_CLIENT_REQUESTS_POLL_TYPE_F_HPP_
...
class ClientEngine;
class PollTypeF : public IRequest {
public:
	PollTypeF() {}
	~PollTypeF() = default;
...
#endif /* INCLUDE_CLIENT_REQUESTS_POLL_TYPE_F_HPP_ */
