...
#ifndef INCLUDE_CLIENT_REQUESTS_CLEAR_NOTIFICATIONS_HPP_
#define INCLUDE_CLIENT_REQUESTS_CLEAR_NOTIFICATIONS_HPP_
...
class ClientEngine;
class ClearNotifications : public IRequest {
public:
	ClearNotifications() {}
...
#endif /* INCLUDE_CLIENT_REQUESTS_CLEAR_NOTIFICATIONS_HPP_ */
