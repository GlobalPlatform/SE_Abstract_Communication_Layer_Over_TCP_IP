...
#ifndef INCLUDE_CLIENT_REQUESTS_POWER_OFF_FIELD_HPP_
#define INCLUDE_CLIENT_REQUESTS_POWER_OFF_FIELD_HPP_
...
#endif /* INCLUDE_CLIENT_REQUESTS_POWER_OFF_FIELD_HPP_ */
